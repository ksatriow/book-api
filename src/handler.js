...
const addBooksRequestHandler = (request, h) => {
  const {
    name,
    author,
    year,
...
const getAllBooksRequestHandler = () => {
...
const getBooksByIdRequestHandler = (request, h) => {
...
const updateBooksByIdRequestHandler = (request, h) => {
  const { id } = request.params;
  const {
    name,
    author,
...
const deleteBooksByIdRequestHandler = (request, h) => {
  const { id } = request.params;
  const index = books.findIndex((book) => book.id === id);
